...
cl.login(token="EmTSPEuVuOJMbMqJZgm9.nMM4Rh5fFP6pFB3iDCWOsq.6qUW7o/ol/tJsru8Pj8ITO6adg1wVbdR25m6ah3h47A=")
cl.loginResult()

ki = LINETCR.LINE() #Minato
ki.login(token="EmyNPg5GluZbPi1rf677.POnI+0U7i1Po/EMXkOsCrW.JgjHDI5fxJWiOPBhKxlDBdzI4wKmskeUNCtukAvF+lc=")
ki.loginResult()

kk = LINETCR.LINE() #Madara
kk.login(token="EmCz3VqULiXW0sQkJtb1.7BIIrkQKLt7frT4XuBGpmq.inV9HwfYPg6kNj8Bd0RTDdj9kZgIrwGM4dk3FNxPr9Q=")
kk.loginResult()

kc = LINETCR.LINE() #Hasirama
kc.login(token="EmAAdNRHvEoovJtCgufa.8oLSZ65oHzLtg/Q3XawOAG.QWMTee5t8PaUFQ1ND5bWN+cj7OTKSsZFiAa9GwtKXzw=")
kc.loginResult()

ks = LINETCR.LINE() #Itama
ks.login(token="EmlMvats1E8C8vRRijt9.N1hSBiNfN+Z9DwLoF/h1Eq.63Aqn48HwjPQTmdAc2EymvLn8wdN2e9JPtOdCe28fXA=")
ks.loginResult()
...
wait = {
    'contact':False,
>>>>>>> u88cd7ee9fd691d6306e5e19be5d16f69
    'autoJoin':True,
...
>>>>>>> b4fb98d66811717c6dcda037275c12f45ae20e79
